...
GenRiver3 is an open source and free web application software. The source code is available at <https://github.com/degi/genriver> and the online version can be accessed from <https://genriver.agroforestri.id/>. The application is developed using R and JavaScript on [R-Shiny](https://shiny.posit.co/) platform. This software can be launched as standalone application from the source code using [R](https://www.r-project.org/) or [RStudio](https://posit.co/products/open-source/rstudio/) (go to the [source code website](https://github.com/degi/genriver) and follow the instructions). 
